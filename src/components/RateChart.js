        ...
        <div style={{marginTop:50, marginBottom:30}}>
            ...
            <div className="d-flex">
                <div className="flex-grow-1">
                    ...
                    <div className="col-3 text-left" style={{fontSize:16}}>
                        5 <span style={{fontSize:11}}><i className="fa fa-star fa-xs" aria-hidden="true" style={{color:"#94fc03"}}></i></span>
                    </div>
                    <div className="col-9">
                    ...
                    <div className="col-3 text-left" style={{fontSize:16}}>
                        4 <span style={{fontSize:11}}><i className="fa fa-star fa-xs" aria-hidden="true" style={{color:"#94fc03"}}></i></span>
                    </div>
                    <div className="col-9">
                        <div className="progress" style={{height:8}}>
                    ...
                    <div className="col-3 text-left" style={{fontSize:16}}>
                        3 <span style={{fontSize:11}}><i className="fa fa-star fa-xs" aria-hidden="true" style={{color:"#94fc03"}}></i></span>
                    </div>
                    <div className="col-9">
                        <div className="progress" style={{height:8}}>
                    ...
                    <div className="col-3 text-left" style={{fontSize:16}}>
                        2 <span style={{fontSize:11}}><i className="fa fa-star fa-xs" aria-hidden="true" style={{color:"#94fc03"}}></i></span>
                    </div>
                    <div className="col-9">
                        <div className="progress" style={{height:8}}>
                    ...
                    <div className="col-3 text-left" style={{fontSize:16}}>
                        1 <span style={{fontSize:11}}><i className="fa fa-star fa-xs" aria-hidden="true" style={{color:"#94fc03"}}></i></span>
                    </div>
                    <div className="col-9">
                        <div className="progress" style={{height:8}}>
